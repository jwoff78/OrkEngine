#region --- OrkEngine.Rendering.OpenAL License ---
/* AlcTokens.cs
 * C header: \OpenAL 1.1 SDK\include\Alc.h
 * Spec: http://www.openal.org/openal_webstf/specs/OpenAL11Specification.pdf
 * Copyright (c) 2008 Christoph Brandtner and Stefanos Apostolopoulos
 * See license.txt for license details
 * http://www.OrkEngine.Rendering.net */
#endregion

using System;

namespace OrkEngine.Rendering.Audio.OpenAL
{
    /// <summary>
    ...
    /// <summary>
    /// Defines available parameters for <see cref="OrkEngine.Rendering.Audio.OpenAL.Alc.GetString(IntPtr, AlcGetString)"/>.
    /// </summary>
