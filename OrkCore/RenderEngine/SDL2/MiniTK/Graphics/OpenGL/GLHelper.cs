...
namespace OrkEngine.Rendering.Graphics.OpenGL
{
    ...
    public sealed partial class GL : GraphicsBindingsBase
    {
        ...
        /// This method is provided for compatibility purposes with older OrkEngine.Rendering versions.
        /// </summary>
        //[Obsolete("If you are using a context constructed outside of OrkEngine.Rendering, create a new GraphicsContext and pass your context handle to it. Otherwise, there is no need to call this method.")]
...
#pragma warning disable 1573
        ...
        {
            int length;
            GetProgram(program, OrkEngine.Rendering.Graphics.OpenGL.ProgramParameter.ActiveAttributeMaxLength, out length);
        ...
        {
            int length;
            GetProgram(program, OrkEngine.Rendering.Graphics.OpenGL.ProgramParameter.ActiveUniformMaxLength, out length);
        ...
        {
            int length;
            GetProgram(program, OrkEngine.Rendering.Graphics.OpenGL.ProgramParameter.ActiveUniformBlockMaxNameLength, out length);
            StringBuilder sb = new StringBuilder(length == 0 ? 1 : length * 2);
        ...
        public static void GetProgramInfoLog(Int32 program, out string info)
        {
            ...
            {
                int length;
                GL.GetProgram(program, OrkEngine.Rendering.Graphics.OpenGL.ProgramParameter.InfoLogLength, out length); if (length == 0)
                {
                    info = String.Empty;
                    return;
                }
        ...
        /// </summary>
        /// <param name="param">
        /// A OrkEngine.Rendering.Graphics.OpenGL.GL.PointSpriteCoordOriginParameter token,
...
#if NO_SYSDRAWING
        public static void Viewport(OrkEngine.Rendering.Point location, OrkEngine.Rendering.Size size)
        {
            GL.Viewport(location.X, location.Y, size.Width, size.Height);
        }

        public static void Viewport(OrkEngine.Rendering.Rectangle rectangle)
        {
            GL.Viewport(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height);
        }
#endif
        ...
        public static void DisableClientState(OrkEngine.Rendering.Graphics.OpenGL.EnableCap array)
        {
        ...
        public static void EnableClientState(OrkEngine.Rendering.Graphics.OpenGL.EnableCap array)
        {
