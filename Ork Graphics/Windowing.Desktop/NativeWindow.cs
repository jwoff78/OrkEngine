...
using OrkCore.Windowing.Common;
using OrkCore.Windowing.Common.Input;
using OrkCore.Windowing.GraphicsLibraryFramework;
using GlfwKeyModifiers = OrkCore.Windowing.GraphicsLibraryFramework.KeyModifiers;
using InputAction = OrkCore.Windowing.GraphicsLibraryFramework.InputAction;
using KeyModifiers = OrkCore.Windowing.Common.Input.KeyModifiers;
using Monitor = OrkCore.Windowing.Common.Monitor;
using MouseButton = OrkCore.Windowing.Common.Input.MouseButton;

namespace OrkCore.Windowing.Desktop
{
    /// <summary>
