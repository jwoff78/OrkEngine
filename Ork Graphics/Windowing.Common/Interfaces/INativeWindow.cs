...
using OrkCore.Windowing.Common.Input;

namespace OrkCore.Windowing.Common
{
    /// <summary>
    ...
    public interface INativeWindow : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets a <see cref="OrkCore.Mathematics.Box2i" /> structure the contains the external bounds of this window,
        ...
        /// <summary>
        /// Gets or sets a <see cref="OrkCore.Mathematics.Vector2i" /> structure that contains the location of this window on the
        /// desktop.
        /// </summary>
        Vector2i Location { get; set; }

        /// <summary>
        /// Gets or sets a <see cref="OrkCore.Mathematics.Vector2i" /> structure that contains the external size of this window.
        /// </summary>
        Vector2i Size { get; set; }

        /// <summary>
        /// Gets or sets a <see cref="OrkCore.Mathematics.Box2i" /> structure that contains the internal bounds of this window,
        ...
        /// <summary>
        /// Gets a <see cref="OrkCore.Mathematics.Vector2i" /> structure that contains the internal size this window.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="OrkCore.Windowing.Common.Input.MouseCursor" /> for this window.
        /// </summary>
        ...
        /// </summary>
        /// <param name="point">
        /// A <see cref="OrkCore.Mathematics.Vector2" /> to transform.
        /// </param>
        /// <returns>
