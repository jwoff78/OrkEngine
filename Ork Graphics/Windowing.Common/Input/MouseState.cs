...
namespace OrkCore.Windowing.Common.Input
{
    /// <summary>
    ...
    public struct MouseState : IEquatable<MouseState>
    {
        ...
        /// </summary>
        /// <param name="button">The <see cref="OrkCore.Windowing.Common.Input.MouseButton" /> to check.</param>
        ...
        /// <summary>
        /// Returns a <see cref="string" /> that represents the current <see cref="OrkCore.Windowing.Common.Input.MouseState" />.
        /// </summary>
        /// <returns>A <see cref="string" /> that represents the current <see cref="OrkCore.Windowing.Common.Input.MouseState" />.</returns>
