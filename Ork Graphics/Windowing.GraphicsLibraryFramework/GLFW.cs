...
using static OrkCore.Core.MarshalUtility;
using static OrkCore.Windowing.GraphicsLibraryFramework.GLFWNative;

namespace OrkCore.Windowing.GraphicsLibraryFramework
{
    /// <summary>
