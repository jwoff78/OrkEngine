...
namespace OrkCore.OpenAL.Extensions.EXT.ALAWFormat
{
    ...
    internal interface IALAWFormat
    {
        ...
        unsafe void BufferData(uint buffer, ALAWBufferFormat format, void* data, int size, int frequency);
    }
}
