...
using OrkCore.OpenAL.Extensions.EXT.Capture.Enumeration;

namespace OrkCore.OpenAL.Extensions.Enumeration
{
    /// <summary>
    ...
    public abstract class CaptureEnumerationEnumeration : ContextExtensionBase, ICaptureEnumerationContextState
    {
        ...
        /// <inheritdoc cref="GetStringList(OrkCore.OpenAL.Device*,OrkCore.OpenAL.Extensions.EXT.Capture.Enumeration.GetCaptureContextStringList)"/>
