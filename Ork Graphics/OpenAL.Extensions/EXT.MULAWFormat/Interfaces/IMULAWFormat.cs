...
namespace OrkCore.OpenAL.Extensions.EXT.MULAWFormat
{
    ...
    internal interface IMULAWFormat
    {
        ...
        unsafe void BufferData(uint buffer, MULAWBufferFormat format, void* data, int size, int frequency);
    }
}
