...
using OrkCore.Audio.OpenAL;
using OrkCore.Audio.OpenAL.Native;
using OrkCore.Core.Native;
using OrkCore.Mathematics;
using OrkCore.OpenAL;

namespace OrkCore.Audio.OpenAL
{
    /// <summary>
    ...
    public partial class AL : ApiContainer<AL>
    {
        ...
        static AL()
        {
            ...
            _ = ApiContainer<AL>.StaticConstructorTrigger;
        }
