...
namespace BEPUphysics.CollisionShapes
{
    ...
    public class CompoundShape : EntityShape
    {
        ...
        public CompoundShape(IList<CompoundShapeEntry> shapes, out System.Numerics.Vector3 center)
        {
            if (shapes.Count > 0)
            {
                float volume;
        ...
        public static void ComputeVolumeDistribution(IList<CompoundShapeEntry> entries, out float volume, out Matrix3x3 volumeDistribution, out System.Numerics.Vector3 center)
        {
            ...
            if (totalWeight <= 0)
                throw new System.NotFiniteNumberException("Cannot compute distribution; the total weight of a compound shape must be positive.");
        ...
        public static void TransformContribution(ref RigidTransform transform, ref System.Numerics.Vector3 center, ref Matrix3x3 baseContribution, float weight, out Matrix3x3 contribution)
        {
            Matrix3x3 rotation;
            ...
            Vector3Ex.Subtract(ref transform.Position, ref center, out offset);
